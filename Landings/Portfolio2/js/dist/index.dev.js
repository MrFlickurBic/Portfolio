...
ctx1.fillRect(8.5, 19, 1.5, 407); //draw line1

ctx1.fillRect(8.5, 95, 44, 1.5); //draw line2

ctx1.fillRect(8.5, 285, 44, 1.5); //#endregion
//#region Canvas2
//canvas draw
...
ctx2.fillRect(8.5, 19, 1.5, 407); //draw line1

ctx2.fillRect(8.5, 95, 44, 1.5); //draw line2

ctx2.fillRect(8.5, 285, 44, 1.5); //#endregion

var isOpen = true; //open sidebar
